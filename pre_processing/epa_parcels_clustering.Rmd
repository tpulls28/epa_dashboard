...
data.shape.clusters.sfr <- readOGR(dsn= "./epabldg_joined_sfr_groups", layer = "epabldg_joined_sfr_groups")
```
...
pal <- colorFactor(
    palette = "Set1",
    domain = data.shape.clusters.sfr@data$SS_GROUP)
# pal <- brewer.pal(n = 4, "Set1")

leaflet(data.shape.clusters.sfr) %>% 
