...
Reading in just a selection of the epa_parcels data. 
```{r}
...
Writing the parcel_data.shape@data df to a csv
```{r}
parcel_data.shape@data$address <- as.character(parcel_data.shape@data$address)
write_csv(as.data.frame(parcel_data.shape@data), "epa_parcel_info.csv")
```
